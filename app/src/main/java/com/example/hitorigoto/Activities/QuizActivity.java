...
public class QuizActivity extends AppCompatActivity {
    ...
    private ArrayList<com.example.hitorigoto.Models.Question> questionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            dbQuiz dbHelper = new dbQuiz(this);
            ...
            questionList = new ArrayList<>(savedInstanceState.<com.example.hitorigoto.Models.Question>getParcelableArrayList(KEY_QUESTION_LIST));
            questionCountTotal = questionList.size();
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr()) {
            case 1:
                ...
                textViewQuestion.setText("Pilihan pertama adalah jawaban yang benar");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText("Pilihan kedua adalah jawaban yang benar");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText("Pilihan ketiga adalah jawaban yang benar");
                break;
        }
